...
::: {#thm-lagrange-remainder .theorem}
...
::: {#thm-second-derivative-test .theorem}
...
fig.savefig("c12_fig01.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c12_fig01.png}\hss}\endL\par
\medskip
```
...
![שני ענפי הפונקציה $f(x)=\frac{x^2+1}{x}$ — ענף ימני עם מינימום ב-$(1,2)$ וענף שמאלי עם מקסימום ב-$(-1,-2)$.](c12_fig01.png){#fig-c08_fig01 width="62%" fig-align="center"}
:::
...
fig.savefig("c12_fig02.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c12_fig02.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![עקומה גלית — החלק העליון (אדום) קמור כלפי מטה והחלק התחתון (כחול) קמור כלפי מעלה.](c12_fig02.png){#fig-c08_fig02 width="62%" fig-align="center"}
:::
...
fig.savefig("c12_fig03.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c12_fig03.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![שני ענפי $f(x)=\frac{x^2+1}{x}$ — הענף הימני ($x>0$) קמור כלפי מעלה והענף השמאלי ($x<0$) קמור כלפי מטה.](c12_fig03.png){#fig-c08_fig03 width="62%" fig-align="center"}
:::
...
fig.savefig("c12_fig04.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c12_fig04.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![הפונקציה $f(x)=x^3$ עם נקודת פיתול בראשית $x=0$.](c12_fig04.png){#fig-c08_fig04 width="62%" fig-align="center"}
:::
...
::: {#exm-vertical-asymptote .example}
**דוגמא:**
...
fig.savefig("c12_fig05.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c12_fig05.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![$f(x)=\frac{x^2+1}{x}$ עם אסימפטוטה אנכית מקווקוות ב-$x=0$ — הענף הימני נשאף ל-$+\infty$ והשמאלי ל-$-\infty$.](c12_fig05.png){#fig-c08_fig05 width="62%" fig-align="center"}
:::
...
fig.savefig("c12_fig06.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c12_fig06.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![שני ענפי $f(x)=\frac{x^2+1}{x}$ עם האסימפטוטה המשופעת $y=x$ (מקווקוות) ב-$\infty$ וב-$-\infty$.](c12_fig06.png){#fig-c08_fig06 width="62%" fig-align="center"}
:::
