...
ax.grid(alpha=0.3)
ax.set_xlim(0.4, 4.6)
fig.savefig("c09_fig01.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig01.png}\hss}\endL\par
\medskip
```
...
![פונקציה רציפה בקטע פתוח $(a,b)$](c09_fig01.png){#fig-c04_fig15 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
ax.set_xlim(0.4, 4.6)
fig.savefig("c09_fig02.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig02.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![פונקציה לינארית יורדת רציפה בקטע סגור $[a,b]$ עם נקודה $x_0$](c09_fig02.png){#fig-c04_fig16 width="62%" fig-align="center"}
:::
...
ax.set_xlim(0.6, 2.6)
ax.set_ylim(2.4, 4.6)
fig.savefig("c09_fig03.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig03.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![אי-רציפות ב-$x=2$ — $\lim_{x\to 2}f(x)=3$ אך $f(2)=4$](c09_fig03.png){#fig-c04_fig17 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
fig.savefig("c09_fig04.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig04.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף פונקציית דיריכלה, שתי שורות נקודות בגובה $1$ (רציונליים) ובגובה $0$ (אי רציונליים)](c09_fig04.png){#fig-c05_fig02 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
fig.savefig("c09_fig05.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig05.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף פונקציית הערך השלם $f(x) = \lfloor x \rfloor$ עם נקודות מלאות וריקות בערכים השלמים](c09_fig05.png){#fig-c05_fig01 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
fig.savefig("c09_fig06.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig06.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![פונקציה רציפה גלית על $[a,b]$ המקבלת כל ערך ביניים $y$ שבין $f(a)$ ל-$f(b)$](c09_fig06.png){#fig-c05_fig05 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
fig.savefig("c09_fig07.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig07.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![הפונקציה $f(x)=x^3-5x-2$ על $[0,3]$ החותכת את ציר ה-$x$ בנקודה $c$, עם $f(0)=-2$ ו-$f(3)=10$](c09_fig07.png){#fig-c05_fig06 width="62%" fig-align="center"}
:::
...
ax.set_xlabel("$x$"); ax.set_ylabel("$f(x)$")
ax.grid(alpha=0.3)
fig.savefig("c09_fig08.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig08.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![פונקציה רציפה בעלת התנהגות גלית בין $a$ ל-$b$](c09_fig08.png){#fig-c05_fig07 width="62%" fig-align="center"}
:::
...
ax.set_xlabel("$x$"); ax.set_ylabel("$f(x)$")
ax.grid(alpha=0.3)
fig.savefig("c09_fig09.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig09.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף עולה של $f(x)=x^3-5x-2$ החותך את ציר ה-$x$ בנקודה $c$, מ-$f(0)=-2$ עד $f(3)=10$](c09_fig09.png){#fig-c05_fig08 width="62%" fig-align="center"}
:::
...
fig.tight_layout()
fig.savefig("c09_fig10.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig10.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![שתי דוגמאות לעקומות $f$ ו-$g$ על $[0,1]$ הנחתכות בנקודה $c$ (כאשר $f(0)<g(0)$ ו-$f(1)>g(1)$)](c09_fig10.png){#fig-c05_fig09 width="62%" fig-align="center"}
:::
...
ax.set_xlabel("$x$"); ax.set_ylabel("$f(x)$")
ax.grid(alpha=0.3)
fig.savefig("c09_fig11.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig11.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![פונקציה רציפה השואפת ל-$5$ עם אסימפטוטה אופקית מקווקוות, החוצה את ציר ה-$x$, עם סימון $x_0$](c09_fig11.png){#fig-c05_fig10 width="62%" fig-align="center"}
:::
...
for ax in axs:
    ax.grid(alpha=0.3)
fig.tight_layout()
fig.savefig("c09_fig12.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c09_fig12.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![שלוש דוגמאות למשפט ויירשטראס: (A) רציפה אך לא חסומה — אי אפשר ליישם; (B) רציפה על $[a,b]$ עם מקסימום ומינימום; (C) רציפה עם כמה $x_{\max}$ ו-$x_{\min}$ — אפשר ליישם](c09_fig12.png){#fig-c05_fig11 width="62%" fig-align="center"}
:::
