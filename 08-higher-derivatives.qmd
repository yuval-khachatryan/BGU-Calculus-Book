...
![שני ענפי הפונקציה $f(x)=\frac{x^2+1}{x}$ — ענף ימני עם מינימום ב-$(1,2)$ וענף שמאלי עם מקסימום ב-$(-1,-2)$.](c08_fig01.png){#fig-c08_fig01 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![עקומה גלית — החלק העליון (אדום) קמור כלפי מטה והחלק התחתון (כחול) קמור כלפי מעלה.](c08_fig02.png){#fig-c08_fig02 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![שני ענפי $f(x)=\frac{x^2+1}{x}$ — הענף הימני ($x>0$) קמור כלפי מעלה והענף השמאלי ($x<0$) קמור כלפי מטה.](c08_fig03.png){#fig-c08_fig03 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![הפונקציה $f(x)=x^3$ עם נקודת פיתול בראשית $x=0$.](c08_fig04.png){#fig-c08_fig04 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![$f(x)=\frac{x^2+1}{x}$ עם אסימפטוטה אנכית מקווקוות ב-$x=0$ — הענף הימני נשאף ל-$+\infty$ והשמאלי ל-$-\infty$.](c08_fig05.png){#fig-c08_fig05 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![שני ענפי $f(x)=\frac{x^2+1}{x}$ עם האסימפטוטה המשופעת $y=x$ (מקווקוות) ב-$\infty$ וב-$-\infty$.](c08_fig06.png){#fig-c08_fig06 width="62%" fig-align="center"}
:::
