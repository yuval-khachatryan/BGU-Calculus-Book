...
![המשיק כגבול של הישרים החותכים והשיפוע כנגזרת](c10_fig01.png){#fig-c06_fig03 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![גזירות גוררת רציפות, אך רציפות אינה גוררת גזירות](c10_fig02.png){#fig-c06_fig01 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![קו מקווקו אלכסוני העובר דרך הראשית](c10_fig03.png){#fig-c06_fig02 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![משולש ישר-זווית עבור arctan(y)](c10_fig04.png){#fig-c06_fig04 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![גרף \|x\| בצורת V עם קודקוד בראשית](c10_fig05.png){#fig-c06_fig05 width="62%" fig-align="center"}
:::
