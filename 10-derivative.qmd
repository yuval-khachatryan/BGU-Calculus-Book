...
fig.savefig("figures/c10_fig01.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c10_fig01.png}\hss}\endL\par
\medskip
```
...
![המשיק כגבול של הישרים החותכים והשיפוע כנגזרת](figures/c10_fig01.png){#fig-c06_fig03 width="62%" fig-align="center"}
:::
...
fig.savefig("figures/c10_fig02.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c10_fig02.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גזירות גוררת רציפות, אך רציפות אינה גוררת גזירות](figures/c10_fig02.png){#fig-c06_fig01 width="62%" fig-align="center"}
:::
...
fig.savefig("figures/c10_fig03.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c10_fig03.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![קו מקווקו אלכסוני העובר דרך הראשית](figures/c10_fig03.png){#fig-c06_fig02 width="62%" fig-align="center"}
:::
...
::: {#box-thm-aritmetika-nagzeret .thmthm}
...
::: {#box-thm-inverse-derivative .thmthm}
...
fig.savefig("figures/c10_fig04.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c10_fig04.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![משולש ישר-זווית עבור arctan(y)](figures/c10_fig04.png){#fig-c06_fig04 width="62%" fig-align="center"}
:::
...
fig.savefig("figures/c10_fig05.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c10_fig05.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף \|x\| בצורת V עם קודקוד בראשית](figures/c10_fig05.png){#fig-c06_fig05 width="62%" fig-align="center"}
:::
...
::: {#box-thm-derivative-iff-one-sided .thmthm}
