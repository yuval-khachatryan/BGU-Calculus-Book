...
ax.grid(alpha=0.3)
ax.set_xlim(0.2, 3.4)
fig.savefig("c04_fig01.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig01.png}\hss}\endL\par
\medskip
```
...
![הגדרת הגבול לפי $\varepsilon$-$\delta$ — רצועה אופקית $L\pm\varepsilon$ ורצועה אנכית $x_0\pm\delta$](c04_fig01.png){#fig-c04_fig01 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
ax.set_xlim(0.2, 3.0)
fig.savefig("c04_fig02.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig02.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גבול $L$ בנקודה $x_0$ שבה הפונקציה אינה מוגדרת — עיגול ריק על הגרף](c04_fig02.png){#fig-c04_fig02 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-0.5, 0.5)
ax.set_ylim(-1.4, 1.4)
fig.savefig("c04_fig05.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig05.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![$f(x)=\sin\left(\frac{1}{x}\right)$ — תנודות צפופות בקרבת הראשית](c04_fig05.png){#fig-c04_fig05 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
fig.savefig("c04_fig03.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig03.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![כלל הסנדוויץ' — $h\le f\le g$ והקצוות נפגשים בנקודה $L$ מעל $x_0$](c04_fig03.png){#fig-c04_fig03 width="62%" fig-align="center"}
:::
...
ax.legend(loc="upper center")
ax.grid(alpha=0.3)
fig.savefig("c04_fig04.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig04.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![כלל הסנדוויץ' — $h\le f\le g$ הכלואות זו בזו ונפגשות בנקודה $L$ מעל $x_0$](c04_fig04.png){#fig-c04_fig04 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-1.3, 3.3)
ax.set_ylim(-1.5, 3.5)
fig.savefig("c04_fig06.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig06.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![פונקציית הערך השלם $f(x)=\lfloor x \rfloor$ — קפיצה בנקודה $x=1$](c04_fig06.png){#fig-c04_fig06 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-0.2, 4)
ax.set_ylim(-0.2, 2.2)
fig.savefig("c04_fig07.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig07.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![הפונקציה $f(x)=\sqrt{x}$ והגבול החד-צדדי $\lim_{x\to 0^+}\sqrt{x}=0$](c04_fig07.png){#fig-c04_fig07 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
fig.savefig("c04_fig08.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig08.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![פונקציה מוגדרת בקטעים — $3x$ משמאל ו-$x^2+2x$ מימין, עם נקודה ריקה ב-$x=1$](c04_fig08.png){#fig-c04_fig08 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-2, 2)
ax.set_ylim(0, 30)
fig.savefig("c04_fig09.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig09.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![$f(x)=\frac{1}{x^2}$ — שואפת לאינסוף בקרבת הראשית](c04_fig09.png){#fig-c04_fig09 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
ax.set_xlim(-12, 12)
fig.savefig("c04_fig10.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig10.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![$f(x)=\arctan x$ — אסימפטוטה אופקית בגובה $\frac{\pi}{2}$](c04_fig10.png){#fig-c04_fig10 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-5, 5)
ax.set_ylim(0, 25)
fig.savefig("c04_fig11.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig11.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![$f(x)=x^2$ — שואפת לאינסוף, עם סימוני $M_1$, $M_2$ על ציר ה-$y$](c04_fig11.png){#fig-c04_fig11 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-2, 2)
ax.set_ylim(0, 30)
fig.savefig("c04_fig12.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig12.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![$f(x)=\frac{1}{x^2}$ — אסימפטוטה אנכית ב-$x=0$](c04_fig12.png){#fig-c04_fig12 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
ax.set_xlim(-12, 12)
fig.savefig("c04_fig13.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig13.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![$f(x)=\arctan x$ — אסימפטוטה אופקית בגובה $\frac{\pi}{2}$](c04_fig13.png){#fig-c04_fig13 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-5, 5)
ax.set_ylim(0, 25)
fig.savefig("c04_fig14.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c04_fig14.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![$f(x)=x^2$ — שואפת לאינסוף, עם הסימונים $M_1$, $M_2$ על ציר ה-$y$](c04_fig14.png){#fig-c04_fig14 width="62%" fig-align="center"}
:::
