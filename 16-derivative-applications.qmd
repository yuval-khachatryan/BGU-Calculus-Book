...
fig.savefig("figures/c16_fig01.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c16_fig01.png}\hss}\endL\par
\medskip
```
...
![פונקציה גלית עם חמש נקודות קיצון מקומיות](figures/c16_fig01.png){#fig-c06_fig06 width="62%" fig-align="center"}
:::
...
fig.savefig("figures/c16_fig02.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c16_fig02.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![הפרבולה x\^2 עם מינימום בראשית](figures/c16_fig02.png){#fig-c06_fig07 width="62%" fig-align="center"}
:::
...
fig.savefig("figures/c16_fig03.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c16_fig03.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף \|x\| בצורת V, מינימום בראשית](figures/c16_fig03.png){#fig-c06_fig08 width="62%" fig-align="center"}
:::
...
fig.savefig("figures/c16_fig04.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c16_fig04.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף x\^3 העולה דרך הראשית עם נקודת פיתול](figures/c16_fig04.png){#fig-c06_fig09 width="62%" fig-align="center"}
:::
...
ax.set_ylabel(r"$y$")
ax.grid(alpha=0.3)
fig.savefig("figures/c16_fig05.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c16_fig05.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף הפונקציה $f(x)=x^3-3x$ בקטע $[-2,2]$ עם נקודות מקסימום (אדום) ומינימום (כחול)](figures/c16_fig05.png){#fig-c07_fig01 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
fig.savefig("figures/c16_fig06.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c16_fig06.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![פונקציה קעורה כלפי מטה מעל $[a,b]$ עם $f(a)=f(b)$ ונקודת מקסימום ביניהן (משפט רול)](figures/c16_fig06.png){#fig-c07_fig02 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
ax.set_ylim(0, fa + 1)
fig.savefig("figures/c16_fig07.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c16_fig07.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![הוכחת משפט לגראנג' — המיתר $g(x)$ בין הקצוות, העקומה $f(x)$ מתחתיו, ומשיק מקווקו ב-$c$ המקביל למיתר](figures/c16_fig07.png){#fig-c07_fig03 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
fig.savefig("figures/c16_fig08.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c16_fig08.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![עקומה מקווקוות (פרבולה הפוכה) מעל הקטע $\left[0,\frac{\pi}{2}\right]$ עם הנקודות $c$, $x_0$, $d$ (תרגיל היחידות)](figures/c16_fig08.png){#fig-c07_fig04 width="62%" fig-align="center"}
:::
