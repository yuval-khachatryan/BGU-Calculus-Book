...
::: {.content-visible when-format="html"}
![דיאגרמת ון: ההפרש הסימטרי $A \triangle B$ הוא כל מה ששייך לאחת הקבוצות בלבד (האזור המוצלל).](c02_fig04.png){#fig-symmetric-difference width="50%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![דיאגרמת ון: המשלים $A^{c}$ הוא כל מה שבתוך העולם $U$ ומחוץ ל-$A$ (האזור המוצלל).](c02_fig05.png){#fig-complement width="50%" fig-align="center"}
:::
