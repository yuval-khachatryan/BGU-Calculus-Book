...
ax.axis("off")
fig.savefig("figures/c06_fig01.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c06_fig01.png}\hss}\endL\par
\medskip
```
...
![ציר מספרים עם הקטע $(L-1,\,L+1)$ סביב הגבול $L$ — כל איברי הסדרה נמצאים בקטע ממקום מסוים](figures/c06_fig01.png){#fig-c02_fig01 width="62%" fig-align="center"}
:::
...
ax.axis("off")
fig.savefig("figures/c06_fig02.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c06_fig02.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![שני קטעים זרים על ציר המספרים — $\left(\tfrac12,\tfrac32\right)$ ו-$\left(-\tfrac32,-\tfrac12\right)$ — המראים שלא קיים $L$ יחיד, ומכאן הסתירה](figures/c06_fig02.png){#fig-c02_fig02 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.4, 0.7)
ax.axis("off")
fig.savefig("figures/c06_fig03.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c06_fig03.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![שני קטעי $\varepsilon=\tfrac{d}{4}$ זרים סביב $L_1$ ו-$L_2$ במרחק $d$ — איבר אחד אינו יכול להיות בשניהם, ומכאן הסתירה](figures/c06_fig03.png){#fig-c02_fig05 width="62%" fig-align="center"}
:::
...
ax.set_aspect("equal")
ax.axis("off")
fig.savefig("figures/c06_fig04.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c06_fig04.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![סדרה מתכנסת גוררת חסומה, אך סדרה חסומה אינה גוררת מתכנסת (אין גרירה הדדית)](figures/c06_fig04.png){#fig-c02_fig03 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.4, 0.4)
ax.axis("off")
fig.savefig("figures/c06_fig05.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c06_fig05.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![הזנב $a_n$ (עבור $n>N$) בקטע $(L-1,L+1)$, והאיברים הראשונים שמחוץ לו — כל הסדרה חסומה בין $m$ ל-$M$](figures/c06_fig05.png){#fig-c02_fig04 width="62%" fig-align="center"}
:::
