...
![ציר מספרים עם הקטע $(L-1,\,L+1)$ סביב הגבול $L$ — כל איברי הסדרה נמצאים בקטע ממקום מסוים](c06_fig01.png){#fig-c02_fig01 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![שני קטעים זרים על ציר המספרים — $\left(\tfrac12,\tfrac32\right)$ ו-$\left(-\tfrac32,-\tfrac12\right)$ — המראים שלא קיים $L$ יחיד, ומכאן הסתירה](c06_fig02.png){#fig-c02_fig02 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![שני קטעי $\varepsilon=\tfrac{d}{4}$ זרים סביב $L_1$ ו-$L_2$ במרחק $d$ — איבר אחד אינו יכול להיות בשניהם, ומכאן הסתירה](c06_fig03.png){#fig-c02_fig05 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![סדרה מתכנסת גוררת חסומה, אך סדרה חסומה אינה גוררת מתכנסת (אין גרירה הדדית)](c06_fig04.png){#fig-c02_fig03 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![הזנב $a_n$ (עבור $n>N$) בקטע $(L-1,L+1)$, והאיברים הראשונים שמחוץ לו — כל הסדרה חסומה בין $m$ ל-$M$](c06_fig05.png){#fig-c02_fig04 width="62%" fig-align="center"}
:::
