...
ax.set_ylim(-0.4, 4)
ax.grid(alpha=0.3)
fig.savefig("c10_fig01.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig01.png}\hss}\endL\par
\medskip
```
...
![השטח הכלוא בין גרף $f$ לציר ה-$x$ בקטע $[a,b]$](c10_fig01.png){#fig-c10_fig01 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.2, 1.6)
ax.grid(alpha=0.3)
fig.savefig("c10_fig02.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig02.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![השטח הכלוא מתחת ל-$f(x)=x^2$ בקטע $[0,1]$](c10_fig02.png){#fig-c10_fig02 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.3, 3)
ax.grid(alpha=0.3)
fig.savefig("c10_fig03.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig03.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![מלבן השטח מתחת לפונקציה הקבועה $f(x)=C$ בקטע $[a,b]$](c10_fig03.png){#fig-c10_fig03 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.1, 1.2)
ax.grid(alpha=0.3)
fig.savefig("c10_fig04.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig04.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![קירוב השטח מתחת ל-$x^2$ ב-$n$ מלבנים (סכום רימן) בקטע $[0,1]$](c10_fig04.png){#fig-c10_fig04 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.3, 1.5)
ax.grid(alpha=0.3)
fig.savefig("c10_fig05.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig05.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![פונקציית דיריכלה בקטע $[0,2]$ — ערך $1$ ברציונליים וערך $0$ באי-רציונליים](c10_fig05.png){#fig-c10_fig05 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.3, 3)
ax.grid(alpha=0.3)
fig.savefig("c10_fig14.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig14.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![השטח המוצלל מתחת ל-$f$ בקטע $[a,b]$, המייצג את $\int_a^b f$](c10_fig14.png){#fig-c10_fig14 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.3, 3.5)
ax.grid(alpha=0.3)
fig.savefig("c10_fig15.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig15.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![הפונקציה $f(x)=|x|$ עם הנקודות $-2,-1,1,2,3$ והשטח המוצלל בקטע $[-2,3]$](c10_fig15.png){#fig-c10_fig15 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.3, 3.4)
ax.grid(alpha=0.3)
fig.savefig("c10_fig16.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig16.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![פונקציית השטח הצבור $F(x)=\int_a^x f(t)\,dt$ — השטח מ-$a$ עד $x$ מתחת לפונקציה יורדת](c10_fig16.png){#fig-c10_fig16 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.2, 2)
ax.grid(alpha=0.3)
fig.savefig("c10_fig06.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig06.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![חלוקה לתת-קטעים עם נקודות מדגם $t_1,\dots,t_n$ ומלבני סכום רימן מתחת ל-$f$](c10_fig06.png){#fig-c10_fig06 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-1.6, 1.7)
ax.grid(alpha=0.3)
fig.savefig("c10_fig07.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig07.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![שטח נטו — אזורים מעל הציר חיוביים ואזור מתחת לציר שלילי ($-\tfrac{1}{2}$)](c10_fig07.png){#fig-c10_fig07 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.4, 4.5)
ax.grid(alpha=0.3)
fig.savefig("c10_fig08.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig08.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![השטח מתחת ל-$f(x)=x^2$ בין $x=-1$ ל-$x=2$](c10_fig08.png){#fig-c10_fig08 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.3, 7)
ax.grid(alpha=0.3)
fig.savefig("c10_fig09.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig09.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![השטחים $1,2,3$ הכלואים בין $f$ ל-$g$ בקטעים $[a,c],[c,d],[d,b]$](c10_fig09.png){#fig-c10_fig09 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-1.3, 1.3)
ax.grid(alpha=0.3)
fig.savefig("c10_fig10.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig10.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![השטחים החסומים בין $f(x)=x$ ל-$g(x)=x^3$ בקטע $[-1,1]$](c10_fig10.png){#fig-c10_fig10 width="62%" fig-align="center"}
:::
...
fig.tight_layout()
fig.savefig("c10_fig11.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig11.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![פונקציה זוגית (סימטרית, השטחים מצטברים) מול פונקציה אי-זוגית (השטחים מתבטלים)](c10_fig11.png){#fig-c10_fig11 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
fig.savefig("c10_fig12.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig12.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![חצי העיגול העליון $y=\sqrt{1-x^2}$ עם מרכז בראשית ורדיוס $1$, השטח צבוע](c10_fig12.png){#fig-c10_fig12 width="62%" fig-align="center"}
:::
...
ax.set_aspect("equal", adjustable="box")
ax.grid(alpha=0.3)
fig.savefig("c10_fig13.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig13.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![חצי מעגל ברדיוס $1$ ומרכז בראשית, הנקודות $0$ ו-$1$ מסומנות על הציר](c10_fig13.png){#fig-c10_fig13 width="62%" fig-align="center"}
:::
...
ax.set_aspect("equal", adjustable="box")
ax.grid(alpha=0.3)
fig.savefig("c10_fig17.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig17.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![חרוט שנוצר מסיבוב הישר $f(x)=x$ סביב ציר ה-$x$](c10_fig17.png){#fig-c10_fig17 width="62%" fig-align="center"}
:::
...
ax.set_aspect("equal", adjustable="box")
ax.grid(alpha=0.3)
fig.savefig("c10_fig18.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig18.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![חרוט שנוצר מסיבוב הישר $f(x)=x$ סביב ציר ה-$y$](c10_fig18.png){#fig-c10_fig18 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-0.3, 3.5)
ax.grid(alpha=0.3)
fig.savefig("c10_fig19.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c10_fig19.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![אורך הקשת של העקומה $f$ בקטע $[a,b]$, עם קווים אנכיים בקצוות](c10_fig19.png){#fig-c10_fig19 width="62%" fig-align="center"}
:::
