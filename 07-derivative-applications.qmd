...
fig.savefig("c06_fig06.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c06_fig06.png}\hss}\endL\par
\medskip
```
...
![פונקציה גלית עם חמש נקודות קיצון מקומיות](c06_fig06.png){#fig-c06_fig06 width="62%" fig-align="center"}
:::
...
fig.savefig("c06_fig07.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c06_fig07.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![הפרבולה x\^2 עם מינימום בראשית](c06_fig07.png){#fig-c06_fig07 width="62%" fig-align="center"}
:::
...
fig.savefig("c06_fig08.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c06_fig08.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף \|x\| בצורת V, מינימום בראשית](c06_fig08.png){#fig-c06_fig08 width="62%" fig-align="center"}
:::
...
fig.savefig("c06_fig09.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c06_fig09.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף x\^3 העולה דרך הראשית עם נקודת פיתול](c06_fig09.png){#fig-c06_fig09 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![גרף הפונקציה $f(x)=x^3-3x$ בקטע $[-2,2]$ עם נקודות מקסימום (אדום) ומינימום (כחול)](c07_fig01.png){#fig-c07_fig01 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![פונקציה קעורה כלפי מטה מעל $[a,b]$ עם $f(a)=f(b)$ ונקודת מקסימום ביניהן (משפט רול)](c07_fig02.png){#fig-c07_fig02 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![הוכחת משפט לגראנג' — המיתר $g(x)$ בין הקצוות, העקומה $f(x)$ מתחתיו, ומשיק מקווקו ב-$c$ המקביל למיתר](c07_fig03.png){#fig-c07_fig03 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![עקומה מקווקוות (פרבולה הפוכה) מעל הקטע $\left[0,\frac{\pi}{2}\right]$ עם הנקודות $c$, $x_0$, $d$ (תרגיל היחידות)](c07_fig04.png){#fig-c07_fig04 width="62%" fig-align="center"}
:::
