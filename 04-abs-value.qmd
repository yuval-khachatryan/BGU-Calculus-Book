...
![ציר מספרים עם הנקודות $-3$, $0$, $3$ וקשתות "מרחק 3" משני הצדדים.](c04_fig01.png){#fig-c01_fig01 width="62%" fig-align="center"}
:::
:::::
...
::: {.content-visible when-format="html"}
![ציר מספרים עם נקודות פתוחות ב-$-1$ וב-$1$, והקטע הפתוח ביניהן.](c04_fig02.png){#fig-c01_fig02 width="62%" fig-align="center"}
:::
:::::
...
::: {.content-visible when-format="html"}
![ציר מספרים עם נקודות סגורות ב-$-1$ וב-$1$, והקטע הסגור ביניהן.](c04_fig03.png){#fig-c01_fig03 width="62%" fig-align="center"}
:::
:::::
...
::: {.content-visible when-format="html"}
![ציר מספרים עם נקודות פתוחות ב-$-3$ וב-$3$, והקרניים החיצוניות מסומנות.](c04_fig04.png){#fig-c01_fig04 width="62%" fig-align="center"}
:::
:::::
...
::: {.content-visible when-format="html"}
![סקיצת משולש וקטורים — וקטור $x$, וקטור $y$ והווקטור $x+y$, להמחשת אי-שוויון המשולש.](c04_fig05.png){#fig-c01_fig05 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![ציר מספרים עם הנקודות $x_0-\varepsilon$, $x_0$, $x_0+\varepsilon$ וקשתות באורך $\varepsilon$ משני צדי $x_0$.](c04_fig06.png){#fig-c01_fig06 width="62%" fig-align="center"}
:::
