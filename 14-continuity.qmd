...
![פונקציה רציפה בקטע פתוח $(a,b)$](figures/c14_fig01.png){#fig-c04_fig15 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![פונקציה לינארית יורדת רציפה בקטע סגור $[a,b]$ עם נקודה $x_0$](figures/c14_fig02.png){#fig-c04_fig16 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![אי-רציפות ב-$x=2$ — $\lim_{x\to 2}f(x)=3$ אך $f(2)=4$](figures/c14_fig03.png){#fig-c04_fig17 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![גרף פונקציית דיריכלה, שתי שורות נקודות בגובה $1$ (רציונליים) ובגובה $0$ (אי רציונליים)](figures/c14_fig04.png){#fig-c05_fig02 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![גרף פונקציית הערך השלם $f(x) = \lfloor x \rfloor$ עם נקודות מלאות וריקות בערכים השלמים](figures/c14_fig05.png){#fig-c05_fig01 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![פונקציה רציפה גלית על $[a,b]$ המקבלת כל ערך ביניים $y$ שבין $f(a)$ ל-$f(b)$](figures/c14_fig06.png){#fig-c05_fig05 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![הפונקציה $f(x)=x^3-5x-2$ על $[0,3]$ החותכת את ציר ה-$x$ בנקודה $c$, עם $f(0)=-2$ ו-$f(3)=10$](figures/c14_fig07.png){#fig-c05_fig06 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![פונקציה רציפה בעלת התנהגות גלית בין $a$ ל-$b$](figures/c14_fig08.png){#fig-c05_fig07 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![גרף עולה של $f(x)=x^3-5x-2$ החותך את ציר ה-$x$ בנקודה $c$, מ-$f(0)=-2$ עד $f(3)=10$](figures/c14_fig09.png){#fig-c05_fig08 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![שתי דוגמאות לעקומות $f$ ו-$g$ על $[0,1]$ הנחתכות בנקודה $c$ (כאשר $f(0)<g(0)$ ו-$f(1)>g(1)$)](figures/c14_fig10.png){#fig-c05_fig09 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![פונקציה רציפה השואפת ל-$5$ עם אסימפטוטה אופקית מקווקוות, החוצה את ציר ה-$x$, עם סימון $x_0$](figures/c14_fig11.png){#fig-c05_fig10 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![שלוש דוגמאות למשפט ויירשטראס: (A) רציפה אך לא חסומה — אי אפשר ליישם; (B) רציפה על $[a,b]$ עם מקסימום ומינימום; (C) רציפה עם כמה $x_{\max}$ ו-$x_{\min}$ — אפשר ליישם](figures/c14_fig12.png){#fig-c05_fig11 width="62%" fig-align="center"}
:::
