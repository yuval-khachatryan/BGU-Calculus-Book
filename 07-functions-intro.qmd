...
![גרף הפרבולה $f(x)=x^2$ עם נקודה $x$ על ציר $X$ והערך $f(x)$ המתאים](figures/c07_fig01.png){#fig-c03_fig01 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![גרף פונקציית הערך השלם $f(x)=\lfloor x \rfloor$ (פונקציית מדרגות) עם הנקודות $x_1, x_2$](figures/c07_fig02.png){#fig-c03_fig02 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![גרף $f(x)=x^2$ עם נקודה $x$ שלילית על ציר $X$ והערך $f(x)$ המתאים](figures/c07_fig03.png){#fig-c03_fig03 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![גרף $f(x)=x^2$ עם הנקודות $-x$ ו-$x$ בעלות אותו ערך $f(x)$](figures/c07_fig04.png){#fig-c03_fig04 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![גרף הפונקציה הזוגית $f(x)=x^2$ - הנקודות $-x$ ו-$x$ בעלות אותו גובה](figures/c07_fig05.png){#fig-c03_fig07 width="62%" fig-align="center"}
:::
...
```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c07_fig06.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף הפונקציה האי-זוגית $f(x)=x^3$ - הנקודות $-x$ ו-$x$ בעלות ערכים נגדיים](figures/c07_fig06.png){#fig-c03_fig08 width="62%" fig-align="center"}
:::
...
```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c07_fig07.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף הישר $f(x)=x+1$](figures/c07_fig07.png){#fig-c03_fig09 width="62%" fig-align="center"}
:::
...
```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c07_fig08.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף $f(x)=\sin x$ עם נקודת מקסימום $(\frac{\pi}{2},1)$ ונקודת מינימום $(\frac{3\pi}{2},-1)$](figures/c07_fig08.png){#fig-c03_fig05 width="62%" fig-align="center"}
:::
...
```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c07_fig09.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף $f(x)=\cos x$ עם נקודת מקסימום $(0,1)$ ונקודת מינימום $(\pi,-1)$](figures/c07_fig09.png){#fig-c03_fig06 width="62%" fig-align="center"}
:::
...
```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c07_fig10.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף $\sin(x)$ על $\left[-\frac{\pi}{2}, \frac{\pi}{2}\right]$ והופכיתו $\arcsin(x)$ על $[-1,1]$](figures/c07_fig10.png){#fig-c05_fig03 width="62%" fig-align="center"}
:::
...
```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{figures/c07_fig11.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף $\tan(x)$ עם אסימפטוטות אנכיות, והופכיתו $\arctan(x)$ עם אסימפטוטות אופקיות ב-$\pm\frac{\pi}{2}$](figures/c07_fig11.png){#fig-c05_fig04 width="62%" fig-align="center"}
:::
