...
ax.set_xlim(-3, 3)
ax.set_ylim(-1, 9)
fig.savefig("c03_fig01.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c03_fig01.png}\hss}\endL\par
\medskip
```
...
![גרף הפרבולה $f(x)=x^2$ עם נקודה $x$ על ציר $X$ והערך $f(x)$ המתאים](c03_fig01.png){#fig-c03_fig01 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-3, 4)
ax.set_ylim(-3.5, 3.5)
fig.savefig("c03_fig02.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c03_fig02.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף פונקציית הערך השלם $f(x)=\lfloor x \rfloor$ (פונקציית מדרגות) עם הנקודות $x_1, x_2$](c03_fig02.png){#fig-c03_fig02 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-3, 3)
ax.set_ylim(-1, 9)
fig.savefig("c03_fig03.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c03_fig03.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף $f(x)=x^2$ עם נקודה $x$ שלילית על ציר $X$ והערך $f(x)$ המתאים](c03_fig03.png){#fig-c03_fig03 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-3, 3)
ax.set_ylim(-1, 9)
fig.savefig("c03_fig04.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c03_fig04.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף $f(x)=x^2$ עם הנקודות $-x$ ו-$x$ בעלות אותו ערך $f(x)$](c03_fig04.png){#fig-c03_fig04 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-3, 3)
ax.set_ylim(-1, 9)
fig.savefig("c03_fig07.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c03_fig07.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף הפונקציה הזוגית $f(x)=x^2$ - הנקודות $-x$ ו-$x$ בעלות אותו גובה](c03_fig07.png){#fig-c03_fig07 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-2, 2)
ax.set_ylim(-8, 8)
fig.savefig("c03_fig08.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c03_fig08.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף הפונקציה האי-זוגית $f(x)=x^3$ - הנקודות $-x$ ו-$x$ בעלות ערכים נגדיים](c03_fig08.png){#fig-c03_fig08 width="62%" fig-align="center"}
:::
...
ax.set_xlim(-3, 3)
ax.set_ylim(-3, 4)
fig.savefig("c03_fig09.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c03_fig09.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף הישר $f(x)=x+1$](c03_fig09.png){#fig-c03_fig09 width="62%" fig-align="center"}
:::
...
ax.grid(alpha=0.3)
ax.set_ylim(-1.5, 1.6)
fig.savefig("c03_fig05.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c03_fig05.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף $f(x)=\sin x$ עם נקודת מקסימום $(\frac{\pi}{2},1)$ ונקודת מינימום $(\frac{3\pi}{2},-1)$](c03_fig05.png){#fig-c03_fig05 width="62%" fig-align="center"}
:::
...
ax.set_ylim(-1.5, 1.6)
fig.savefig("c03_fig06.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c03_fig06.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף $f(x)=\cos x$ עם נקודת מקסימום $(0,1)$ ונקודת מינימום $(\pi,-1)$](c03_fig06.png){#fig-c03_fig06 width="62%" fig-align="center"}
:::
...
fig.tight_layout()
fig.savefig("c05_fig03.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c05_fig03.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף $\sin(x)$ על $\left[-\frac{\pi}{2}, \frac{\pi}{2}\right]$ והופכיתו $\arcsin(x)$ על $[-1,1]$](c05_fig03.png){#fig-c05_fig03 width="62%" fig-align="center"}
:::
...
fig.tight_layout()
fig.savefig("c05_fig04.png", dpi=150, bbox_inches="tight")
plt.close(fig)
```

```{=latex}
\par\medskip
\noindent\beginL\hbox to \linewidth{\hss\includegraphics[width=0.62\linewidth]{c05_fig04.png}\hss}\endL\par
\medskip
```
...
::: {.content-visible when-format="html"}
![גרף $\tan(x)$ עם אסימפטוטות אנכיות, והופכיתו $\arctan(x)$ עם אסימפטוטות אופקיות ב-$\pm\frac{\pi}{2}$](c05_fig04.png){#fig-c05_fig04 width="62%" fig-align="center"}
:::
